 ...
 */
public abstract class JmsDestination extends JndiAwareResource {
    ...
    /**
     * @parameter property = "security"
     */
    private JmsSecurity security;
    ...
    public void setDestinationName(String destinationName) {
        ...
        this.destination = new Destination(destinationName, getType());
    }
	...
	public JmsSecurity getSecurity() {
		return security;
	}

	public void setSecurity(JmsSecurity jmsSecurity) {
		this.security = jmsSecurity;
	}
