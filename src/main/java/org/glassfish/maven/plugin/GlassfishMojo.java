...
public abstract class GlassfishMojo extends AbstractMojo {
    ...
    /**
     * @parameter description = "Debug Glassfish output" default-value = "false"
     */
    private boolean debug;

    /**
     * @parameter description = "Force component deployment" default-value = "false"
     */
    private boolean force;

    /**
     * @parameter description = "Echo Glassfish asadmin commands" default-value = "false"
     */
    private boolean echo;

    /**
     * @parameter description = "Terse Glassfish output"  default-value = "true"
     */
    private boolean terse = true;

    /**
     * @parameter description = "Automatically create the domain if it does not already exist" default-value = "true"
     */
    private boolean autoCreate;

    /**
     * @parameter description = "The asadmin user to create for domain administration." expression = "${glassfish.adminUser}" default-value = "${user.name}"
     */
    private String user;
